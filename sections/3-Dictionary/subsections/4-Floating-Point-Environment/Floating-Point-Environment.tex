...
\subfile{definitions/1-floating-point-environment.tex}
\subfile{definitions/2-accessors.tex}
\subfile{definitions/3-set-floating-point-environment.tex}
\subfile{definitions/4-get-floating-point-environment.tex}
\subfile{definitions/5-default-floating-point-environment.tex}
\subfile{definitions/6-with-floating-point-environment.tex}
