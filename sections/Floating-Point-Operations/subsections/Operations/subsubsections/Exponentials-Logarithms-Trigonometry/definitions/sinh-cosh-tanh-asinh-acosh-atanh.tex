...
\begin{itemize}
  ...
  $\equiv$ \code{(* \#c(0 1) (sin \#c(}\varname{y}\code{ (-
  }\varname{x}\code{)))}
\end{itemize}
...
\begin{itemize}
  ...
  $\equiv$ \code{(cos \#c(}\varname{y}\code{ (-
  }\varname{x}\code{)))}
\end{itemize}
...
\begin{itemize}
  ...
  $\equiv$ \code{(* \#c(0 1) (tan \#c(}\varname{y}\code{ (-
  }\varname{x}\code{)))}
\end{itemize}
...
\begin{itemize}
  ...
  $\equiv$ \code{(* \#c(0 1) (asin \#c(}\varname{y}\code{ (-
  }\varname{x}\code{)))}
\end{itemize}
...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    $\equiv$ \code{(* \#c(0 1) (acos \#c(}\varname{x}\code{
    }\varname{y}\code{)))}
...
\begin{itemize}
  ...
  $\equiv$ \code{(* \#c(0 1) (atan \#c(}\varname{y}\code{ (-
  }\varname{x}\code{)))}
\end{itemize}
