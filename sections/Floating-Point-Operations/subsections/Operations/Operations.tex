...
\emph{same} symbols exported by the \code{COMMON-LISP} package; 
see also \code{is-cl-using-cdr-ieee-754}.
...
\subfile{subsubsections/Type-Manipulation-Coercion/Type-Manipulation-Coercion.tex}
