...
\subfile{definitions/01-addition-multiplication.tex}
\subfile{definitions/02-addition-rounded.tex}
\subfile{definitions/03-multiplication-rounded.tex}
\subfile{definitions/04-subtraction.tex}
\subfile{definitions/05-subtraction-rounded.tex}
\subfile{definitions/06-division.tex}
\subfile{definitions/07-division-rounded.tex}
\subfile{definitions/08-plus-minus-one.tex}
\subfile{definitions/09-incf-decf.tex}
\subfile{definitions/10-conjugate.tex}
