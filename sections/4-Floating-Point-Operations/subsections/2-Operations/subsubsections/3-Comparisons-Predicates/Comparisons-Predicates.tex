...
\begin{tt}
  ...
  \subfile{definitions/01-equals.tex}
  \subfile{definitions/02-great-less.tex}
  \subfile{definitions/03-is-neg-zero.tex}
  \subfile{definitions/04-is-tiny.tex}
  \subfile{definitions/05-signum.tex}
  \subfile{definitions/06-residue.tex}
  \subfile{definitions/07-sqrt.tex}
  \subfile{definitions/08-exponent-fraction.tex}
  \subfile{definitions/09-scale-float.tex}
  \subfile{definitions/10-ieee-754-not-implemented-item.tex}
