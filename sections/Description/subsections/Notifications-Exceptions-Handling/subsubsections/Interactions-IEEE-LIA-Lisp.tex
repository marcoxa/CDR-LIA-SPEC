...
\code{cl:division-by-zero})\marginnote{As noted by phoe, we also need
  to specify when a condition is "serious" or not and when it is
  signalled by \code{signal} and when it is signalled by \code{error}}
