...
\newcommand{\CLLIAPKG}{\code{CL-MATH-LIA-2019}}
...
\item An enumerated type for NRI, NACF and NTM: %\\
  \code{arithmetic-exception-notification-style}.
  \begin{alltt}
    (deftype \codelia{arithmetic-exception-notification-style} ()
...
CL prompt> \codeprompt{(fpe-test-exceptions :division-by-zero)}
\textit{T}
\end{alltt}
...
This is the parameter \textit{bounded}$_I$ required in LIA1
\cite{2012:LIA1}.
...
The value of \code{minimum-fixnum} is \code{most-negative-fixnum}.\\
The value of \code{maximum-fixnum} is \code{most--fixnum}.
...
required in LIA1 \cite{2012:LIA1}.  Their values are the obvious \CL{}
counterparts.
...
\DDictionaryItem{Values \index{N!\code{NAN}}}
...
\DDictionaryItem{Functions \index{I!\code{is-nan}}, \index{N!\code{nanp}},
  \index{I!\code{is-quiet-nan}},
  \index{Q!\code{quiet-nan-p}},\\\index{I!\code{is-signalling-nan}}, 
  \index{S!\code{signalling-nan-p}}}
...
\DDictionaryItem{Functions \index{I!\code{is-infinity}}, \index{I!\code{infinityp}}}
...
\DDictionaryItem{Type \index{F!\code{fpe-exception}}}
...
\DDictionaryItem{Type \index{F!\code{fpe-exceptions-set}}}
...
\DDictionaryItem{Constant Value \index{*!\code{+fpe-all-exceptions+}}}
...
\DDictionaryItem{Functions \index{S!\code{supported-exception-p}},\\
  \index{A!\code{all-supported-exceptions-p}},
  \index{S!\code{some-supported-exceptions-p}}}
...
\DDictionaryItem{Function \index{F!\code{fpe-test-exceptions}}}
...
\DDictionaryItem{Function \index{F!\code{fpe-check-exceptions}}}
...
\DDictionaryItem{Type \index{F!\code{floating-point-environment}}}
...
\DDictionaryItem{Accessors \index{F!\code{fpe-traps}}, \index{F!\code{fpe-rounding-mode}},
  \index{F!\code{fpe-current-exceptions}}, \index{F!\code{fpe-accrued-exceptions}},
  \index{F!\code{fpe-precision}}, \index{F!\code{fpe-fast-mode-p}}}
...
\DDictionaryItem{Function \index{S!\code{set-floating-point-environment}}}
...
\DDictionaryItem{Function \index{G!\code{get-floating-point-environment}}}
...
\DDictionaryItem{Function \index{D!\code{default-floating-point-environment}}}
...
\newpage
\DDictionaryItem{Macro \index{W!\code{with-floating-point-environment}}}
...
\DDictionaryItem{Type \index{R!\code{rounding-mode}}}
...
\DDictionaryItem{Function \index{G!\code{get-rounding-mode}}}
...
\DDictionaryItem{Function \index{S!\code{set-rounding-mode}}}
...
\DDictionaryItem{Macro \index{W!\code{with-rounding-mode}}}
...
\DDictionaryItem{Macros \index{R!\code{round-to-zero}}, \index{R!\code{round-to-near}},
...
\DDictionaryItem{Function \index{I!\code{is-cdr-ieee-754-conformant}}}
...
\DDictionaryItem{Function \index{I!\code{is-cdr-ieee-745-constants-providing}}}
...
\DDictionaryItem{Function \index{I!\code{is-cdr-ieee-745-environment-providing}}}
...
\DDictionaryItem{Function \index{I!\code{is-cdr-ieee-745-operation-providing}}}
...
\DDictionaryItem{Function \index{I!\code{is-cl-using-cdr-ieee-745}}}
...
\DDictionaryItem{Features \index{*!\code{:cdr-ieee-745-constants-providing}},\\
  \index{*!\code{:cdr-ieee-745-environment-providing}} and\\
...
\DDictionaryItem{Error \index{I!\code{ieee-754-not-implemented-item}}}
...
or\ldots
\begin{alltt}
    (let ((saved-flags (\codelia{fpe-test-exceptions +fpe-all-exceptions+})))
       (unwind-protect
           (progn (\codelia{fpe-clear-expections +fpe-all-exceptions+})
                  \textit{\ldots run desired code \ldots}
                  \textit{\ldots examine indicators \ldots}
                  \textit{\ldots clear some indicators \ldots}
                  )
