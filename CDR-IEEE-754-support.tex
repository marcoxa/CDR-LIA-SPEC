...
\subfile{sections/1-Introduction/Introduction.tex}
\newpage

\section{Description}
\subfile{sections/2-Description/Description.tex}
\newpage

\section{LIA \CL{}-related Dictionary}
\subfile{sections/3-Dictionary/Dictionary.tex}
\newpage

\section{Floating Point \IEEEFPStd{} Respecting Operations}
\subfile{sections/4-Floating-Point-Operations/Floating-Point-Operations.tex}
\newpage
...
\subfile{sections/A-Example-Program/Example-Program.tex}

\section{Copying and License}
\subfile{sections/B-License/License.tex}
