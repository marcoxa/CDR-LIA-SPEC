...
\item An enumerated type for NRI, NACF and NTM: %\\
  \code{arithmetic-notification-notification-style}.
  \begin{alltt}
    (deftype \codelia{arithmetic-notification-notification-style} ()
...
a \emph{quiet} (\code{Q-NAN}) or a \emph{signalling} (\code{S-NAN})
\emph{NaN} (see~\cite{2008:IEEE-754}).  \code{NAN} ia always a
\emph{quiet NaN}.
...
\index{I!\code{is-signalling-nan}} 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\DDictionaryItem{Macro \code{with-rouding-mode}}
